...
- [ ] **Phase 1: Test Infrastructure + Constants** - Configure Vitest and externalize all magic numbers before any refactoring begins
...
|-------|----------------|--------|-----------|
| 1. Test Infrastructure + Constants | 0/TBD | Not started | - |

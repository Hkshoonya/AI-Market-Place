...
export function PurchaseButton({
  ...
  }, [open, user, isFree, fetchBalance]);

  const handleOpenChange = (value: boolean) => {
    // Prevent closing while purchase is in progress
  ...
  // Dialog title for accessibility + display
      ...
      >
        ...
        {delivery ? (
              ...
              {delivery.api_key && (
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => copyToClipboard(delivery.api_key!, "api_key")}
          ...
          <>
            ...
            {/* Insufficient balance -- deposit addresses */}
            {insufficientBalance && (
                ...
                {walletData?.solana_deposit_address && (
                  <div className="space-y-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => copyToClipboard(walletData.solana_deposit_address!, "sol")}
                ...
                {walletData?.evm_deposit_address && (
                  <div className="space-y-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => copyToClipboard(walletData.evm_deposit_address!, "evm")}
            ...
            <div className="flex gap-2 pt-2">
              ...
              <Button
                className="flex-1 bg-neon text-background hover:bg-neon/90"
                disabled={purchasing || loadingWallet || insufficientBalance}
                onClick={handlePurchase}
              >
                {purchasing ? (
                  <>
